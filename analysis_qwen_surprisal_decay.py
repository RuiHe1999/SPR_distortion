...
OUT = "results/qwen3/surprisal_decay"
...
make_qwen_main_figure(
    trajectory_label="surprisal",
    top_ylabel="Distorted − Original\ncontextual surprisal",
    boundary_ylabel="Additional surprisal effect\nat sentence boundary",
    persistence_ylabel="Model-estimated surprisal difference",
    output_stem="surprisal_distance_results",
)
